...
This repository contains code for training and evaluating machine translation models on the WMT17 dataset, 
with a focus on Chinese-English translation. 
The project supports multiple pre-trained models and provides functionality for model training, inference, and result analysis.
...
The data are downloaded from Huggingface and preprocessed automatically as you run one of
